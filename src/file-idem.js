...
//
// WHY THIS EXISTS. An in-process reservation map loses every entry on
// restart. A client that retries a request whose
...
//            — work is running right now. Share the promise: two concurrent
//              retries, one mutation.
...
// restart (the systemd-restart case this was built for). It
...
// That inference is unsound. A post-state observed NOW is not evidence about the past: our
