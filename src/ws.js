  ...
  try {
    switch (msg.op) {
      ...
      case 'send': {
        ...
        // transcript for durability and are READ-ONLY to clients: a user send
        // would inject an orphan message no session is reading, and can race
        // a mid-upload media reclassification.
