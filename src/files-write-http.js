// HTTP surface of the File Explorer WRITE API.
...
// a key is reusable for a deliberate repeat soon after.
...
export async function handleFilesWriteRoute(ctx, req, res, url, who) {
  ...
  // exist, so an attempt falls through to http.js's final 404.
